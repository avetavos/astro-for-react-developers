---
title: Navigation
description: 'Plain <a href> แบบ MPA, Astro.url สำหรับ active link, และ ClientRouter สำหรับ animation แบบ SPA — เทียบกับ <Link> และ useRouter'
---
...
## ClientRouter — animation แบบ SPA
...
- SPA transition: Next.js รองรับ first-class ผ่าน App Router; Astro ใช้ `<ClientRouter />` (import เดียว)
...
export const quizNavigation = [
  ...
  {
    q: "การเพิ่ม `<ClientRouter />` ลงใน Astro layout ทำอะไร?",
    options: [
