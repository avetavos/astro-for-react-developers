...
<ReactAstro react={firstPageReact} astro={firstPageAstro} />
...
- React/Next: ฟังก์ชันคืน JSX → React runtime render → hydrate ใน browser
- Astro: frontmatter คำนวณค่า → template render เป็น HTML → browser รับ HTML เท่านั้น
...
export const quizFirstPage = [
  ...
  {
    q: "คุณเรียก `new Date()` ใน Astro frontmatter โค้ดนี้รันเมื่อใด?",
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      "React fragment ที่ hydrate ใน browser",
