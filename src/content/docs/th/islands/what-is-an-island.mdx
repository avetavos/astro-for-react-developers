...
<ReactAstro react={hydrationReact} astro={hydrationAstro} />
...
จุดสุดท้ายสำคัญมาก: islands ถูกแยกออกจากกัน ไม่มี React tree เดียวที่เชื่อมต่อกัน ซึ่งหมายความว่าไม่มีการแชร์ React context ข้าม islands โดยค่าเริ่มต้น คุณจะได้เรียนรู้วิธีจัดการกับนั้นใน [เมื่อใดควรใช้ Island](/astro/th/islands/when-to-island/)
...
<ReactAstro react={islandConceptReact} astro={islandConceptAstro} />
...
export const quizWhatIsIsland = [
  {
    ...
    options: [
      ...
      "การส่ง JavaScript แบบบีบอัดไปยัง browser",
    ],
    answer: 0,
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      "browser ต้องดาวน์โหลดและรัน JS สำหรับทุก component รวมถึง component ที่แสดงผลล้วนๆ",
      "React ต้องการการเชื่อมต่อฐานข้อมูลเพื่อ hydrate",
      "browser cache React bundles ทำให้โหลดครั้งแรกช้าลง",
    ],
    answer: 1,
  },
  {
