...
<ReactAstro react={propsSerializableReact} astro={propsSerializableAstro} />
...
<ReactAstro react={propsPassing} astro={propsPassingAstro} />
...
export const quizPassingProps = [
  {
    ...
    options: [
      ...
      "Astro serialize props เข้า HTML ตอน build/SSR เพื่อให้ browser rehydrate ด้วยข้อมูลเดิม",
