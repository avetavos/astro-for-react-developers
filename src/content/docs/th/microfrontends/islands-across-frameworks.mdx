...
- **การจับคู่กับทีม:** หนึ่ง island ≈ หนึ่งทีม contract ระหว่างทีมก็เป็นเพียง props ที่ shell ส่งเข้ามาและ slot ที่เรนเดอร์ลงไป
- **การแยกตัว (Isolation):** error หรือการเรนเดอร์ที่หนักใน island หนึ่งจะอยู่ใน island นั้น static shell และเพื่อนบ้านของตัวเองไม่ได้รับผลกระทบ
</Diff>
...
export const quizIslands = [
  ...
  },
  {
    ...
    options: [
      "บังคับให้ทุกทีมอยู่บน framework เดียวกัน",
      "แต่ละ island hydrate อย่างเป็นอิสระและสามารถมาจาก framework ที่ต่างกันได้",
      "ปิด JavaScript ทั้งหมด",
      "ต้องการเซิร์ฟเวอร์แยกต่อหนึ่ง island",
    ],
    answer: 1,
  },
  {
    ...
    options: [
      "ว่าโหลดไฟล์ CSS ไหน",
      "ว่าจะ hydrate และส่ง JavaScript หรือไม่และเมื่อไหร่",
      "ว่าทีมไหนเป็นเจ้าของตัวเอง",
      "ตำแหน่งของตัวเองใน layout",
    ],
    answer: 1,
  },
];
