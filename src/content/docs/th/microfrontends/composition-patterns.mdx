...
- **Run-time:** fragment ที่ deploy แยกกันและถูกดึงมาตอนร้องขอหรือใน browser deploy อิสระอย่างแท้จริง — แต่ความปลอดภัย ณ เวลา compile อ่อนแอลงและ infrastructure มากขึ้น
...
- **กฎคร่าวๆ:** เริ่มที่ build-time เพื่อความปลอดภัย ย้าย slice ไปยัง run-time ก็ต่อเมื่อทีมของตัวเองจำเป็นต้องมีจังหวะการ deploy ที่เป็นอิสระอย่างแท้จริงเท่านั้น
</Diff>
...
export const quizComposition = [
  {
    ...
    options: [
      "ในฐานะ remote fragment ที่ถูกดึงมาใน browser",
