...
export const quizWhat = [
  {
    ...
    options: [
      ...
      "ฟีเจอร์ที่เบ็ดเสร็จในตัวเองตั้งแต่ UI ลงไปจนถึง data source ของตัวเอง",
  ...
  },
  {
    ...
    options: [
      ...
      "slice แบบ run-time เป็น artifact ที่ deploy แยกกันและถูกดึงมาตอนร้องขอหรือใน browser",
