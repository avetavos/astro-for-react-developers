---
title: Navigation
description: 'Plain <a href> MPA navigation, Astro.url for active links, and ClientRouter for SPA-like animations — compared to <Link> and useRouter.'
---
...
<ReactAstro react={navReact} astro={navAstro} reactTitle="Next.js" />
...
## ClientRouter — SPA-like animations
...
<ReactAstro react={vtReact} astro={vtAstro} reactTitle="Next.js" />
...
- SPA transitions: Next.js has first-class support via the App Router; Astro uses `<ClientRouter />` (one import).
...
export const quizNavigation = [
  ...
  {
    q: "What does adding `<ClientRouter />` to an Astro layout do?",
    options: [
