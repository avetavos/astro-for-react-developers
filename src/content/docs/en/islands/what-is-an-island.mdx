...
That last point matters: islands are isolated. There is no single React tree connecting them, which means no shared React context across islands by default. You will learn how to work with that in [When to Use an Island](/astro/en/islands/when-to-island/).
